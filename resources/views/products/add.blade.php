                ...
                <div class="card" bis_skin_checked="1">
                    ...
                    <div class="card-body" bis_skin_checked="1">
                        ...
                        <div class="mt-3" bis_skin_checked="1">
                            ...
                            <textarea id="des" class="form-control  @error('product_description'){{ 'is-invalid' }}@enderror"
                                name="product_description" placeholder="Enter Product Description">{{ old('product_description') }}</textarea>
                        ...
                        <div class="col-xl-3" bis_skin_checked="1">
                            <label class="btn btn-outline-secondary" for="flupld"
                                style="@error('product_theme'){{ 'border:2px solid red' }}@enderror">
                                <i class="ti ti-upload me-2"></i> Click to Upload
                            </label>
                            <input type="file" id="flupld" name="product_theme" class="d-none">
                            @error('product_theme')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
